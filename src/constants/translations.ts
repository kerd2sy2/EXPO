export const translations = {
  ar: {
    ...
    passwordPlaceholder: 'أدخل كلمة المرور (أو آخر 6 أرقام من الهوية)',
  ...
  en: {
    ...
    passwordPlaceholder: 'Enter password (or last 6 digits of ID)',
  ...
  bn: {
    ...
    passwordPlaceholder: 'পাসওয়ার্ড দিন (বা আইডির শেষ ৬ ডিজিট)',
