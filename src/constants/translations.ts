export const translations = {
  ar: {
    ...
    startShiftNow: 'بدء الدوام',
    endShiftNow: 'إنهاء الدوام',
    ...
    outOnDifferentBike: 'أنت طالع الآن بدباب',
    branch: 'الفرع',
    ...
    quickShiftTitle: 'بدء الدوام',
    quickShiftSub: 'تسجيل قراءات العدادات والتقاط الصور',
    quickHistoryTitle: 'سجل الطلبات',
    ...
    savingStartBtn: 'جاري بدء الدوام وحفظ البيانات...',
    endShiftTitle: 'إنهاء الدوام',
    ...
    confirmEndBtn: 'إنهاء الدوام وإرسال البيانات',
    savingEndBtn: 'جاري إنهاء الدوام وحفظ البيانات...',
  ...
  en: {
    ...
    startShiftNow: 'Start Work',
    endShiftNow: 'End Work',
    ...
    outOnDifferentBike: 'Currently out on bike',
    branch: 'Branch',
    ...
    quickShiftTitle: 'Start Work',
    quickShiftSub: 'Record odometer readings & take photos',
    quickHistoryTitle: 'Orders History',
    ...
    savingStartBtn: 'Starting shift & saving data...',
    endShiftTitle: 'End Work',
    ...
    confirmEndBtn: 'End Work & Submit Data',
    savingEndBtn: 'Ending shift & saving data...',
    historyTitle: 'Orders History',
  ...
  bn: {
    ...
    startShiftNow: 'কাজ শুরু',
    endShiftNow: 'কাজ সমাপ্তি',
    ...
    outOnDifferentBike: 'আপনি এখন যে বাইকে আছেন',
    branch: 'শাখা',
    ...
    quickShiftTitle: 'কাজ শুরু',
    quickShiftSub: 'মিটার রিডিং রেকর্ড এবং ছবি তুলুন',
    quickHistoryTitle: 'অর্ডার ইতিহাস',
    ...
    savingStartBtn: 'কাজ শুরু হচ্ছে ও তথ্য সংরক্ষণ হচ্ছে...',
    endShiftTitle: 'কাজ সমাপ্তি',
    ...
    confirmEndBtn: 'কাজ শেষ ও জমা দিন',
    savingEndBtn: 'কাজ সমাপ্ত হচ্ছে ও তথ্য সংরক্ষণ হচ্ছে...',
    historyTitle: 'অর্ডার ইতিহাস',
